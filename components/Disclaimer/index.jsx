  ...
  <TypographyContainer>
    ...
    <ol>
      ...
      <li>
        ...
        YOUR OWN RISK, AND WITHOUT WARRANTIES OF ANY KIND. Valory AG will not be
        liable for any loss, whether such loss is direct, indirect, special or
        consequential, suffered by any party as a result of their use of this
        app.
      </li>
      <li>
        This App is for research purposes only. It uses several models
        including:
        <ol className="custom-list">
          <li>
            Stable Video Diffusion, which is licensed under the Stable Video
            Diffusion Research License, Copyright © Stability AI Ltd. All
            Rights Reserved.
          </li>
          <li>GPT-3.5 and DALL·E 3, Copyright © Open AI.</li>
          <li>
